...
def _run_startup_migrations():
    ...
    with engine.connect() as conn:
        for ddl in [
            ...
            "ALTER TABLE matches ADD COLUMN score_90_home INTEGER",
            "ALTER TABLE matches ADD COLUMN score_90_away INTEGER",
            "ALTER TABLE predictions ADD COLUMN is_random INTEGER NOT NULL DEFAULT 0",
        ]:
            try:
