...
export default function LeaderboardPage() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-black mb-5">🏆 טבלת דירוג</h1>
          ...
          <tbody>
            {users.map((user, idx) => (
              ...
              >
                ...
                <td className="py-3 px-4 text-center">
                  <span className={`font-black text-lg ${idx === 0 ? 'text-yellow-400' : idx === 1 ? 'text-white/80' : idx === 2 ? 'text-orange-400' : 'text-white'}`}>
                    {user.total_points}
                  </span>
                </td>
              </tr>
